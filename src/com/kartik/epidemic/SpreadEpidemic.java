...
public class SpreadEpidemic {
    ...
    public void spread() throws IOException {
        ...
        List<String> lines = Files.readAllLines(Paths.get("src/com/kartik/epidemic/Population.java"), Charset.defaultCharset());
        ...
        try (FileWriter writer = new FileWriter("src/com/kartik/epidemic/Population.java", false)) {
